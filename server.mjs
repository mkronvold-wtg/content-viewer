  ...
  <style>
    ...
    @media (prefers-color-scheme: dark) {
      :root:not([data-color-mode="light"]) {
        --dashboard-bg: var(--background-color-default, #0d1117);
        --dashboard-text: var(--text-color-default, #e6edf3);
        --dashboard-muted: var(--text-color-muted, #8b949e);
        --dashboard-border: var(--border-color-default, #30363d);
        --dashboard-border-muted: #21262d;
        --dashboard-hr: #6e7681;
        --dashboard-surface: #161b22;
        --dashboard-input-bg: #161b22;
        --dashboard-button-bg: #21262d;
        --dashboard-button-hover-bg: #30363d;
        --dashboard-hover-bg: rgba(56, 139, 253, 0.14);
        --dashboard-active-bg: rgba(56, 139, 253, 0.22);
        --dashboard-active-border: #58a6ff;
        --dashboard-code-bg: #161b22;
        --dashboard-code-border: #30363d;
